...
Mi proyecto utiliza un enfoque de documentación basada en código, en lugar de crear un archivo .json manualmente, utilice atributos de PHP (OpenApi\Attributes) directamente en mis controladores y modelos, de manera que al ejecutar el comando de generación del paquete l5-swagger, el archivo swagger.json se construye automáticamente, esto garantiza que la documentación siempre refleje el estado actual de la API.
